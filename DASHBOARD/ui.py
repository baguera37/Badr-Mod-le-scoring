...
pred = pd.read_csv('df_pred_display.csv')
...
# Utiliser la fonction pour encoder l'image et l'utiliser dans le layout
logo_src = encode_image('logo.png')
...
# fonction de rappel pour la page Prédictions
@app.callback(
